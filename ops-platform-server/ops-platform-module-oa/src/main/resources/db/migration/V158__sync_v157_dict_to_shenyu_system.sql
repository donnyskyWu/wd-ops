-- V158: Sync wd.sys_dict_* rows added after V152 (e.g. V157 dict_ai_scene) → shenyu-system
-- DictService / frontend DictSelect read @DS("system") → shenyu-system.system_dict_*.
