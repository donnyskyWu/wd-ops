...
PATCH = ROOT / "scripts/integration-config/patch-system-role-menu-user-type.sql"
...
def apply(host: str, port: str, user: str, password: str, database: str) -> int:
    ...
    verify = subprocess.run(
        ...
        + [
            ...
            "WHERE table_schema=DATABASE() AND table_name='system_role_menu' AND column_name='user_type';",
        ],
        capture_output=True,
    )
