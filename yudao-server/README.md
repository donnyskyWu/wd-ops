...
2.Stop-Process -Id 54832 -Force -ErrorAction SilentlyContinue; Start-Sleep -Seconds 2; netstat -ano | findstr :8080
3.Set-Location "d:\self\sy\运营数据平台\202606\wd\yudao-server\yudao-module-oa"; mvn -q compile -DskipTests
4.Set-Location "d:\self\sy\运营数据平台\202606\wd\yudao-server\yudao-module-oa"; mvn spring-boot:run "-Dspring-boot.run.profiles=dev"