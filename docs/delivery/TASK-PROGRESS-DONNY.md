...
|---|-------|---------|------|------|--------|------|
| 1 | **S-R21-Donny** | D-1 / B-3 | `Efficiency.vue` 去掉 ADR-008 占位文案；内容 KPI 展示真值 | 0.5~1d | `Efficiency.vue` · `types/productivity.ts` | S-R21-Mike ✅ |
| 2 | **S-R25-Donny** | P-3 | 清理高频 `as any`（enum-alias / api 响应） | 1d | `src/views/**` · `src/api/**` | — |
| 3 | **S-R25-Donny** | P-4 | Playwright 3 个 skip 测试补全 | 0.5d | `tests/**` | — |
| 4 | **P-2** | P-2 | Playwright 全量复测 console 0 error | 0.5d | `tests/**` | S-R25 |
