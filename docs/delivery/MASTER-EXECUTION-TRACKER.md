...
| �?| Phase 2-A | 后期 | M10 采集 | 🔵 | �?| �?| �?| �?| | | 待 ADR-070 批准后启动；详见 §17.1 + [ADR-070](../adr/ADR-070-Ops抓取统一XXL-JOB调度.md) |
...
| P2-M10-A | api.json | M10-API-S-01~S-06 + V121/V122 全量 dataType | `UnifiedCollectorAdapter` + bind + 多平台落库 + `CollectedDataQueryService` 桥接（[ADR-047](../adr/ADR-047-M4-平台账号凭证SSOT与Collector映射.md) · [ADR-049](../adr/ADR-049-M10-全量采集与展示桥接.md) · [ADR-070](../adr/ADR-070-Ops抓取统一XXL-JOB调度.md)· **含 ADR-069 P1 同步改造**） | 🔵 MVP 完成：stub/HTTP IT + 展示桥接 IT；**待 Gate 签收**与生产 collector 全类型人工联调 |
...
### 17.3 FR-M2-010 工作任务管理（Post-S7 · 2026-08-19）

| ID | 切片 | 状态 | 说明 |
|----|------|------|------|
| FR-M2-010-S16 | S-16 | ✅ | ADR-071/072 Accepted · Flyway V181 · 字典/菜单/AI prompt · DO/Mapper 骨架 |
| FR-M2-010-S17 | S-17 | 🔄 | sheet CRUD + confirm/withdraw + Tab1 |
| FR-M2-010-S18 | S-18 | ⏳ | matrix API + Tab2 |
| FR-M2-010-S19 | S-19 | ⏳ | 红黑 hourly Job · ADR-072 |

Spec SSOT：[`PRD-M2-工作任务管理.md`](../product/PRD-M2-工作任务管理.md)
