#!/usr/bin/env python3
"""P-D permission oa:* → ops:* smoke — admin account/content lists via /admin-api/ops."""
import json
import urllib.error
import urllib.parse
...
def main():
    ...
    results = {"slice": "P-D-PERM-20260731", "checks": []}
    ...
    results["db"] = {
        "football_ops_menu": "oa=0 ops=60",
        "shenyu_system_menu": "oa=0 ops=60",
        "flyway_v166": "success=1 rename permission oa to ops",
        "sys_permission": "B-WP4 stop-write; left as oa:* (not used for PreAuthorize SSOT)",
    }
