...
-- Effect: block INSERT/UPDATE/DELETE; SELECT still allowed
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_user is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_user_token is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_role is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_user_role is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_role_permission is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_permission is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_dict_type is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.sys_dict_data is stop-write (read-only)';
END$$
...
FOR EACH ROW
BEGIN
  SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'B-WP4-ARCHIVE: wd.system_users overlay is stop-write (read-only)';
END$$
