  ...
  <div class="phone-page">
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px">
      <el-form :model="formData" :rules="formRules" ref="formRef" label-width="100px">
        ...
        <el-form-item label="保管人ID" prop="keeperId">
          <el-input-number v-model="formData.keeperId" :min="1" />
...
const formRules = {
  ...
  keeperId: [{ required: true, message: '请指定保管人', trigger: 'blur' }],
}
  ...
  await formRef.value.validate(async (valid: boolean) => {
    ...
    try {
      ...
      if (formData.id) {
        ...
        await updatePhone(updatePayload as any)
      } else {
